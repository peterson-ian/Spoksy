...
{
    public class GetChatQueryTests : IntegrationTestBase
    {
        ...
        private readonly IGetAllMessageQueryHandler _getAllMessagesHandler;
        private readonly IGetChatQueryHandler _handler;
        ...
        public GetChatQueryTests() : base()
        {
            ...
            _getAllMessagesHandler = new GetAllMessageQueryHandler(_dbConnectionFactory, _chatValidationService);
            _handler = new GetChatQueryHandler(_dbConnectionFactory, _getAllMessagesHandler, _chatValidationService);
        ...
        public async Task Handle_WithValidCommand_ShouldReturnChat()
        {
            ...
            Assert.Equal(_existingChat.Id, result.Value.Id);
            Assert.Equal(_existingMessage.Content, result.Value.Messages.Items.First().Content);
        }
